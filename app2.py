...
vdef dashboard_escritorio():
    ...
    st.plotly_chart(fig_peso, use_container_width=True)  QUERO CRIAR UM GRAFICO DE PIZZA DE GENERO COM BASE NA COLUNA  Nome do Funcionáriodef dashboard_escritorio():
    st.title("🏢 Análise de Efetivo - Escritório")
    ...
    st.plotly_chart(fig_peso, use_container_width=True)  QUERO CRIAR UM GRAFICO DE PIZZA DE GENERO COM BASE NA COLUNA  Nome do Funcionário
# ======================================
