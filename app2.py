...
if not st.session_state.logged_in:
    ...
    def carregar_produtividade():
        ...
        df_produtividade.columns = df_produtividade.columns.str.strip()
        return df_produtividade

    # Exibir o dashboard de produtividade
    df_produtividade = carregar_produtividade()
    st.subheader("📊 Dashboard de Produtividade")
    st.dataframe(df_produtividade)

    # Botão para visualizar o dashboard de produtividade
    if st.button("Abrir Dashboard de Produtividade"):
        st.dataframe(df_produtividade)
